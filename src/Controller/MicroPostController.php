...
class MicroPostController
{
                                ...
                                AuthorizationCheckerInterface $authorizationChecker)
    {
        ...
        $this->authorisationChekcer = $authorizationChecker;
    }
    ...
    {
        if(!$this->authorisationChekcer->isGranted('edit', $microPost))
        {
            throw new UnauthorizedHttpException();
        }
        $form = $this->formFactoryInterface->create(MicroPostType::class, $microPost);
     ...
     * @Security("is_granted('delete', microPost)", message="Acces denied")
     */
     ...
     */
    public function add(Request $request, \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorageInterface $tokenStorage)
    {
